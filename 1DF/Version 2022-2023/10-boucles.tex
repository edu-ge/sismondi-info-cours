...
\begin{exercice}
Imaginez et écrivez ici :
\item[a)] une boucle infinie, n'atteignant jamais sa condition de fin : \vskip+3cm
\item[b)] une boucle qui n'exécute jamais son bloc d'instructions: \vskip+3cm
\end{exercice}
...
\begin{exercice}
Écrivez un programme permettant d'additionner les 100 premiers entiers naturels (1, 2, ..., 100). % reponse : 5050.
\end{exercice}
